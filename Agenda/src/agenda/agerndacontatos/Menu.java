...
public class Menu {
	...
	/**
	 * Exibe as opcoeses do menu e aguarda a escolha do usuario
	 * @return Ocao escolhida
	...
	public int exibirOpcoes() throws AgendaException {
		...
		// Checa se a opcao invalida
		if (opcao > OPCAO_SAIR || opcao < OPCAO_INSERIR) {
			throw new AgendaException("Opcao invalida");
		}
		
		// Retorna a opcaoo escolhida
		return opcao;
	}
}
